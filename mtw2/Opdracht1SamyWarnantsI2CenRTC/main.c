...
int main(void)
{
    ...
    int mday = 29, month = 1, year = 2024; // Day of month, month and year
    int hours = 11, minutes = 19, seconds = 30; // Hours, minutes and seconds
	...
	int check = 0;
    printf("--------Application RTC basic started on %s--------\r\n",buffer2);
    cyhal_i2c_t mI2C;
